...
if(isset($_POST["email"]) && isset($_POST["password"])){
	...
	if($count == 1){
		...
		$ip_add = getenv("REMOTE_ADDR");
			...
			echo "<span style='color:red;border:1px solid #c0c0c0;border-radius:5px;display:block;background-color:#fff;padding:10px 15px;margin-top:10px;text-align:center;'>Please register before login..!</span>";
			exit();
		}
